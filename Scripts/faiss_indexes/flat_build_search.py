# Builds a Flat FAISS index from existing isolate_embeddings.npy files.
...
def process_model(model_dir):
    ...
    flat_dir = model_dir / "faiss_indexes" / "flat"
    flat_dir.mkdir(parents=True, exist_ok=True)

    index_out = flat_dir / "flat.index"
    metadata_out = flat_dir / "flat_metadata.csv"
    neighbors_out = flat_dir / "flat_neighbors.csv"
    metrics_out = flat_dir / "flat_metrics.csv"
    runtime_out = flat_dir / "flat_runtime.csv"
